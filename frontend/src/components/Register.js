        ...
        {file ? (
          ...
          >
            ...
            <div style={{ textAlign: "left" }}>
              <div
                style={{ fontWeight: 600, fontSize: "14px", color: "#d3101f" }}
              >
                {file.name}
              </div>
...
function Register({ onLogin, onBack, onGoLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!criminalFile)
      return setError("Please upload your criminal record document.");
    ...
    return (
      <div
        style={{
          ...
          justifyContent: "center",
          background:
            "linear-gradient(135deg, #2d0505 0%, #1a0808 50%, #3d0010 100%)",
        }}
      >
        <div
          style={{
        ...
        >
          ...
          <div
            style={{
              ...
              transform: approved ? "scale(1.15)" : "scale(1)",
            }}
          >
            {approved ? "✅" : "🔍"}
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontSize: "14px",
                        color: done ? "#38a169" : active ? "#d3101f" : "#aaa",
          ...
          >
            <div
              style={{
                ...
                borderRadius: "99px",
                width: `${progress}%`,
                background: approved ? "#38a169" : "#d3101f",
                transition: "width 0.9s ease, background 0.4s",
              }}
            />
          </div>
          ...
          {!approved && (
            <p style={{ fontSize: "13px", color: "#999" }}>
              Estimated time:{" "}
              <strong style={{ color: "#d3101f" }}>{countdown}s</strong>
            </p>
          )}
        </div>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    padding: "14px",
                    border: `2px solid ${form.role === "renter" ? "#d3101f" : "#e0e0e0"}`,
                    borderRadius: "12px",
                    background: form.role === "renter" ? "#fff0f0" : "#fff",
                  ...
                  <div style={{ minWidth: 0 }}>
                    <div
                      style={{
                        fontSize: "15px",
                        fontWeight: 700,
                        color: form.role === "renter" ? "#d3101f" : "#444",
                        lineHeight: "20px",
                      }}
                    >
                      👤 Renter
                ...
                <div
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    padding: "14px",
                    border: `2px solid ${form.role === "owner" ? "#d3101f" : "#e0e0e0"}`,
                    borderRadius: "12px",
                    background: form.role === "owner" ? "#fff0f0" : "#fff",
                    boxSizing: "border-box",
                    minWidth: 0,
                  }}
                >
                  ...
                  <div style={{ minWidth: 0 }}>
                    <div
                      style={{
                        fontSize: "15px",
                        fontWeight: 700,
                        color: form.role === "owner" ? "#d3101f" : "#444",
                        lineHeight: "20px",
                      }}
                    >
                      🚗 Car Owner
